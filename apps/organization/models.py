...
class CurseOrg(models.Model):
    ...
    category = models.CharField(verbose_name=u"机构类别", default=u"培训机构", max_length=20, choices=(("pxjg", "培训机构"), ("gr", "个人"), ("gx", "高校")))
...
class Teacher(models.Model):
    org = models.ForeignKey(CurseOrg, verbose_name=u"所属机构")
